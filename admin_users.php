   ...
   <body>
      ...
      <section class="user-accounts">
         ...
         <div class="box-container"> 
            <div class="box"> <form method="GET" class="search-form">
            ...
            <?php
               ...
               if(isset($_GET['search'])){
                  ...
                  $select_users = $conn->prepare("SELECT * FROM `users` WHERE `name` LIKE ? OR `email` LIKE ? OR `user_type` LIKE ?");
                  $select_users->execute([$search_term, $search_term, $search_term]);
               } else {
            ...
            <div class="box" style="<?php if($fetch_users['id'] == $admin_id){ echo 'display:none'; }; ?>">
               ...
               <a href="admin_users.php?delete=<?= $fetch_users['id'] . (isset($_GET['search']) ? '&search=' . $_GET['search'] : ''); ?>" onclick="return confirm('Delete this user?');" class="delete-btn">Delete</a>
            </div>
            <?php
               }
            ?>
